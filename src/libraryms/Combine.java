...
public class Combine extends JFrame {
    ...
    public Combine() {
        ...
        borrowedBookButton.addActionListener(e -> JOptionPane.showMessageDialog(Combine.this, "Borrowed Book clicked"));

        developerButton.addActionListener(e -> JOptionPane.showMessageDialog(Combine.this, "Developer clicked"));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(Combine::new);
    }
}
